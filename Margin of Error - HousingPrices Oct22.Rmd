...
I would say the headline is not statistically justified because for the 52% support of the population of 100 the margin of error is 10%. Therefore, the data can go down to 42% occasionally since we don't know the exact margin of error at all times. In order for the headline to have been statistically justified the support level would need to reamin above the 50% at all times even with the negative margin of error. In this instance these requirements are noit met. 
...
Based on the results, it is showen that the transit line is increasing the value of the homes. Local officials say the new light rail line is driving up home values. Recent sales averaged more than $305,000, about $20,000 higher than before the extension opened. A statistical test shows the increase is significant, suggesting the transit project has played a real role in boosting neighborhood property prices.
