...
Based on the scatterplot there is a moderately strong positive correlation between the GDP and DJIA. There seems not to be any outliers helping the data confrim the strong correlation while also going in a upward trajectory proving the positive correlation.  
