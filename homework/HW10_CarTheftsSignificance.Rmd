...
**WRITE ANSWERS HERE:**
The trend is that there is a steadily decrease in the number of car thefts as time goes on. it starts north of 600 but in 2025 it drops down to below 300. 
...
- What does the 95% confidence interval show here? **WRITE ANSWER HERE:**
  The 95% confidence interval is the shaded red band that shows the range where they are 95% confident the true average monthly number of car thefts lies, based on the sample data. While individual months vary, the long-run average is very likely between those upper and lower bounds.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:**
 The mean value of about 460 thefts per month is the best single figure for a “typical” month. The confidence interval  also gives a good sense of the usual range for monthly thefts, even though some months fall outside of it.
...
Car Theft Rates Stabilize Around 460 Monthly, With Recent Drops Hinting at Continued Decline
...
No, the difference between the two periods is not statistically significant. The p-value shown is 0.179, which is greater than the common threshold of 0.05. This means we cannot reject the null hypothesis. In other words, while the first half shows a higher average compared to the second half, the difference could be due to random chance rather than a real change in car theft rates.
...
I would revise my headline slightly to avoid overstating the trend, since the difference between the two periods is not statistically significant. Instead of suggesting a clear decline, I would frame it more cautiously. I would expect her to ask me do we need to do more research to get a stronger claim or are you confident in our findings. 
