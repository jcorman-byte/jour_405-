...
Some questions I have regarding the results I found are that one survey that had 30% woman and 3% men is kinda interesting and i feel that that survey cant be as accurate due to the skew of sex asked. Another one is the percent of multiracial people that experienced Emotional or Mental Difficulties by Faculty Respondents. 
...
1. What is the range of weights in this dataset? **Write your answer here:** when you subtract the maximum from the minimum you get 2.8088. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:** A respondent with a weight of 0.23 is under-represented in the survey population compared to the sample. A respondent with a weight of 3.04 is over-represented in the survey population compared to the sample. Their answers count for a little over three people in the analysis.

3. Why might some respondents be weighted more heavily than others? **Write your answer here:** 
Some respondents will be weighted more heavily than others because  their type of respondent is less common in the survey than in the real population. The extra weight helps make sure the survey results better represent everyone.
...
The rarely/never category had the most change for all 3 columns whether it was positive or negative. 

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:**
These might affect reporting on voter turnout by possibly making the reporting more accurate by looking at these results. Reporters aim to try to be as accurate as possible and these differences might be able to assist them with that.
...
The people who always vote are over represneted simply because they always vote. Then the voters who rarely show up are underrepresented. 