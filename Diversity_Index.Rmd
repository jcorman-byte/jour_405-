...
Most diverse cities would definitely include Baltimore, Germantown, and Columbia. The data set contains how diverse all the different cities are in the state of Maryland. It states all the numbers of all the different races that can be found and how many of each race in each city. 
...
Summerfield has the highest race probability with 87%. I think that is the case because it is the least diverse city in Maryland. It's black percentage is just at 93% meaning that there is little to no other races in the city. Making it a better chance that if two randomly selected people from Summerfield would probably be 2 black people. 
...
Chillum has the lowest Hisp_Prob score with 50%. This is probably the case because they have one of the biggest ranges between people that are and aren't hispanic. The less people that identift as Hispanic or Latino the lower that cities Hisp_prob score is gonna be. Furthermore, they have a diverse % of 87% meaning that this will correlate by showing a lower hispanic probability then other ciites. 
...
Langley Park, Wheaton, and Adelphi are the three cities that are the most diverse. Langley Park and Adelphi are in Prince George's County. Wheaton is in Montgomery County. Lake Shore and Lake Arbor are the least diverse. Lake Shore is in Anne Arundel County, while Lake Arbor is in PG county. 
...
headline: Langley Park Tops Maryland Diversity Rankings, Reflecting State’s Shifting Demographics

lede: Langley Park, a Prince George’s County community where no single racial or ethnic group holds a majority, ranks as Maryland’s most diverse city according to a new USA TODAY-based analysis of 2020 Census data. The Diversity Index shows that there’s nearly a nine-in-ten chance any two residents will come from different racial or ethnic backgrounds, a reflection of decades of immigration and population change reshaping the D.C. suburbs. I would visit Langley Park, Wheaton, and Adelphi, the three highest-scoring cities, to capture how diversity shapes daily life.
Interviews: local residents, small-business owners, community leaders, and school administrators who see these demographic shifts firsthand. I’d also speak with a demographer from the University of Maryland or a Prince George’s County planning official to contextualize the trends.
Some questions I would ask are What has driven population growth and diversity in these areas? How do residents feel their communities have changed over the past decade?
