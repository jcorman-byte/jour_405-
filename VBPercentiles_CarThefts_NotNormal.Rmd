...
Your name:
Justin Corman and Wesley Schnell 
...
**Your answer**: One example of data that might not be normally distributed is household income. I feel like income would be skewed to the right because there are extreme cases of different household making a lot more money then the normal household. Another example that wouldn't be normal is college student's GPA. This distribution can be skewed either to the right or the left because if more students are struggling to maintain a high GPA then there will be a skew to the left in the distribution. 
...
**Answer**: Maryland's ranks in the 95 percentile. This shows they rank within the top 95% of all volleyball schools with aces. That is very impressive and indicates they are very successful. When being compared to Towson who are in the 91st percentile, Maryland had 13 more aces then Towson. Towson had 210 while Maryland had 223. 
...
**Answer**: The distribution is skewed a little bit to the left. I would say around 70% of the data falls in the range of one standard deviation. 
